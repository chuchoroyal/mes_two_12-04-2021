  ...
  
  {
  ...
  }],[7,
    {
    ...
    }],[8,
      {
        ...
        {
          id:9, source:"./img/foto9.jpg",
        }],[10,
          {
            id:10, source:"./img/foto10.jpg",
          }],[11,
            {
              id:11, source:"./img/foto11.jpg",
            }],[12,
              {
                id:12, source:"./img/foto12.png",
              }],[13,
                {
                  id:13, source:"./img/foto13.jpg",
                }],[14,
                  {
                    id:14, source:"./img/foto14.jpg",
                  }],[15,
                    {
                      id:15, source:"./img/foto15.jpg",
                    }]
]
...
function endGame(resultGame, score){  
  document.getElementById('result-msg').innerHTML = resultGame + " - " + score + " Good";  
  result.classList.toggle("land-hide");  
}
